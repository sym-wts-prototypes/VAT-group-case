...
interface WtsTopNavProps {
  className?: string
  /** Figma 15728:28563 — red badge on bell. Defaults to 0 (no badge), matching Figma default state. */
    ...
    >
      <div className="flex w-full items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <button
            type="button"
            className="inline-flex items-center gap-1 rounded-lg p-0 text-sm font-medium text-sky-800 hover:text-sky-900"
          >
            EN
