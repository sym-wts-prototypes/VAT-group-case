...
>(({ className, align = "center", sideOffset = 4, ...props }, ref) => (
  <PopoverPrimitive.Portal>
    <PopoverPrimitive.Content
      ...
      className={cn(
        // pointer-events-auto: when this Popover is nested inside a modal Dialog/Sheet,
        // Radix sets document.body's pointer-events to none and only re-enables it on the
        // Dialog's own content. This Popover portals to <body> as a sibling of that content,
        // so it inherits pointer-events:none and becomes click-through unless restored here.
