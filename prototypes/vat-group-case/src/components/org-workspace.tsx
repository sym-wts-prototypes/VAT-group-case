...
import {
  ...
  Link2, Unlink, Activity, ClipboardList, X,
  Check, MapPin, Trash2,
} from "lucide-react";
...
export function OrgWorkspace({
  ...
  return (
    // h-full + overflow-y-auto — WtsAppShell's non-fullscreen content slot is a fixed-height,
    // overflow-hidden box, so this page must own its own scroll region or content past that
    // height (e.g. a growing legal-entity list) gets clipped instead of scrolling.
